    ...
    public class Unlock
    {
        public static void Achievements()
        {
            ...
            string[] achievments = { "ACH_WON_INN_NIGHTMARE", "ACH_WON_INN_NIGHTMARE_SP", "ACH_WON_INN_HARD", "ACH_WON_INN_HARD_SP", "ACH_WON_INN_COOP", "ACH_ALL_ROSES", "ACH_BURNT_GOAT",
                ...
                "ACH_WON_MOLLY_COOP", "ACH_WON_MOLLY_HARD", "ACH_WON_MOLLY_NIGHTMARE", "ACH_20_TRASH_CANS_KICKED", "ACH_CALM_MOLLY_10_TIMES", "ACH_FRIED_1000_SPIDERS",
                "ACH_20_BLEACH_USED", "ACH_WON_SLAUGHTERHOUSE_NIGHTMARE", "ACH_WON_SLAUGHTERHOUSE_HARD", "ACH_WON_SLAUGHTERHOUSE_NIGHTMARE_SP", "ACH_WON_TOWN_SP",
                "ACH_WON_TOWN_HARD_SP", "ACH_WON_TOWN_NIGHTMARE", "ACH_WON_SLAUGHTERHOUSE_SP", "ACH_1000_BOOKS_DESTROYED", "ACH_WON_TOWN_COOP", "ACH_WON_SLAUGHTERHOUSE_HARD_SP",
                "ACH_1000_PIGS_DESTROYED", "ACH_WON_TOWN_NIGHTMARE_SP", "ACH_ALL_HORSESHOES", "ACH_ALL_BARBED_WIRES", "ACH_WON_SLAUGHTERHOUSE_COOP", "ACH_WON_TOWN_HARD",
                "ACH_100_BOOKS_CURSED", "ACH_WON_NIGHTMARE_NO_MEDKITS", "ACH_WON_HARD_NO_MEDKITS", "ACH_WON_NO_MEDKITS", "ACH_WON_NO_BATTERIES", "ACH_WON_HARD_NO_BATTERIES",
                "ACH_WON_NIGHTMARE_NO_BATTERIES", "ACH_20_POOPS_SEARCHED", "ACH_FRIED_1000_GHOSTS", "ACH_FRIED_1000_BOARS", "ACH_FRIED_100_CORPSES", "ACH_CALM_SAM_20_TIMES"
            };
